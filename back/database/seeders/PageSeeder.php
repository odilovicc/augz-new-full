...
class PageSeeder extends Seeder
{
    ...
    private function aboutContent(): array
    {
        return [
            ...
            'timeline' => [
                'label'   => ['ru' => 'С 2013 года',  'uz' => '2013 yildan',   'en' => 'Since 2013'],
                'heading' => ['ru' => 'НАША ИСТОРИЯ', 'uz' => 'BIZNING TARIXIMIZ', 'en' => 'OUR HISTORY'],
                'items' => [
                    ['year' => '2013', 'title' => ['ru' => 'Основание',       'uz' => 'Tashkil etilgan', 'en' => 'Founded'],       'desc' => ['ru' => 'Создание ассоциации и первое объединение участников рынка.',      'uz' => "Uyushma tashkil etildi va bozor ishtirokchilari birinchi marta birlashdi.",   'en' => 'The association was founded and market participants were first united.']],
                    ['year' => '2015', 'title' => ['ru' => 'Обучение',        'uz' => "Ta'lim",          'en' => 'Training'],      'desc' => ['ru' => 'Запуск образовательных программ для специалистов по закупкам.',    'uz' => "Xaridlar bo'yicha mutaxassislar uchun ta'lim dasturlari ishga tushirildi.",  'en' => 'Educational programs launched for procurement specialists.']],
                    ['year' => '2019', 'title' => ['ru' => '100+ участников', 'uz' => '100+ ishtirokchi','en' => '100+ members'],  'desc' => ['ru' => 'Ассоциация объединила более 100 компаний и профессионалов.',       'uz' => "Uyushma 100 dan ortiq kompaniya va mutaxassislarni birlashtirdi.",            'en' => 'The association united over 100 companies and professionals.']],
                    ['year' => '2022', 'title' => ['ru' => 'Партнёрства',     'uz' => 'Hamkorliklar',    'en' => 'Partnerships'],  'desc' => ['ru' => 'Расширение международных партнёрств и цифровых инициатив.',       'uz' => "Xalqaro hamkorliklar va raqamli tashabbuslar kengaytirildi.",                'en' => 'International partnerships and digital initiatives expanded.']],
                    ['year' => '2026', 'title' => ['ru' => 'Сегодня',         'uz' => 'Bugun',           'en' => 'Today'],         'desc' => ['ru' => 'Свыше 1000 членов, 20+ проектов, лидер отрасли.',                 'uz' => "1000 dan ortiq a'zo, 20+ loyiha, soha yetakchisi.",                         'en' => 'Over 1000 members, 20+ projects, industry leader.']],
                ],
            ],
        ];
    }
        ...
        return [
            ...
            'sections' => [
                [
                    ...
                    'items' => [
                        ['number' => '01', 'title' => ['ru' => 'Тендерная стратегия и анализ рынка',    'uz' => 'Tender strategiyasi va bozor tahlili',    'en' => 'Tender strategy and market analysis'],    'desc' => ['ru' => 'Разработка индивидуальной стратегии участия в тендерах: анализ конкурентов, выбор перспективных лотов, ценовое позиционирование и прогноз вероятности победы', 'uz' => "Raqobatchilar tahlili, istiqbolli lotlarni tanlash, narx pozitsiyalash va g'alaba ehtimolini prognoz qilish", 'en' => 'Individual tender strategy: competitor analysis, lot selection, price positioning and win probability forecast'], 'tags' => ['СТРАТЕГИЯ', 'АНАЛИЗ КОНКУРЕНТОВ', 'ЦЕНООБРАЗОВАНИЕ']],
                        ['number' => '02', 'title' => ['ru' => 'Подготовка тендерной документации',     'uz' => 'Tender hujjatlarini tayyorlash',          'en' => 'Tender documentation preparation'],      'desc' => ['ru' => 'Полный пакет документов для участия в тендере: техническое предложение, ценовая заявка, банковские гарантии. Соответствие требованиям законодательства и ТЗ', 'uz' => "Tenderda ishtirok etish uchun to'liq hujjatlar paketi: texnik taklif, narx takliflari, bank kafolatlari", 'en' => 'Full document package: technical proposal, price bid, bank guarantees. Legislative compliance'], 'tags' => ['ДОКУМЕНТАЦИЯ', 'ЗАЯВКИ']],
                        ['number' => '03', 'title' => ['ru' => 'Правовой консалтинг и обжалование',     'uz' => 'Huquqiy konsalting va shikoyat',          'en' => 'Legal consulting and appeals'],          'desc' => ['ru' => 'Юридическая экспертиза тендерных условий, защита прав участников, подготовка жалоб и представительство интересов клиента в антимонопольных органах', 'uz' => 'Tender shartlarini yuridik ekspertizasi, ishtirokchilar huquqlarini himoya qilish, shikoyatlar tayyorlash', 'en' => "Legal audit of tender conditions, protection of participants' rights, complaint preparation and antitrust representation"], 'tags' => ['ПРАВО', 'ОБЖАЛОВАНИЕ']],
                        ['number' => '04', 'title' => ['ru' => 'Аудит закупочных процедур',             'uz' => 'Xarid tartib-qoidalarini audit qilish',   'en' => 'Procurement procedure audit'],           'desc' => ['ru' => 'Независимая проверка закупочных процедур заказчика на соответствие требованиям законодательства, выявление рисков и рекомендации по улучшению', 'uz' => "Buyurtmachining xarid tartib-qoidalarini qonunchilik talablariga muvofiqligini mustaqil tekshirish, xavflarni aniqlash", 'en' => 'Independent audit of procurement procedures for legislative compliance, risk identification and improvement recommendations'], 'tags' => ['АУДИТ', 'КОМПЛАЕНС', 'РИСКИ']],
                    ],
                    'stats' => [
                ...
                [
                    ...
                    'products' => [
                        ['icon' => 'heroicons:bolt',          'accent' => '#D1832C', 'name' => ['ru' => 'TenderZone',       'uz' => 'TenderZone',       'en' => 'TenderZone'],       'tagline' => ['ru' => 'Агрегатор тендеров',    'uz' => 'Tenderlar agregatori',     'en' => 'Tender aggregator'],  'desc' => ['ru' => 'Крупнейший агрегатор государственных и корпоративных тендеров Узбекистана. 15 000+ активных лотов, анализ и Telegram-уведомления в реальном времени', 'uz' => "O'zbekistonning eng yirik davlat va korporativ tenderlar agregatori. 15 000+ faol lot, tahlil va real vaqtda Telegram-bildirishnomalar", 'en' => "Uzbekistan's largest aggregator of state and corporate tenders. 15,000+ active lots, analysis and real-time Telegram notifications"], 'features' => ['150 000+ тендеров в базе', 'Telegram-бот с уведомлениями', 'CRM для отдела закупок', 'Аналитика конкурентов'], 'link' => 'https://trade.tzone.uz/page/tenders-all', 'link_label' => ['ru' => 'trade.tzone.uz/page/tenders-all', 'uz' => 'trade.tzone.uz/page/tenders-all', 'en' => 'trade.tzone.uz/page/tenders-all']],
                        ['icon' => 'heroicons:chart-bar',     'accent' => '#3B82F6', 'name' => ['ru' => 'АУГЗ Аналитика',   'uz' => 'AUGZ Analitika',   'en' => 'AUGZ Analytics'],   'tagline' => ['ru' => 'Платформа данных',       'uz' => "Ma'lumotlar platformasi", 'en' => 'Data platform'],      'desc' => ['ru' => 'Интерактивная платформа с данными о рынке государственных закупок: динамика цен, рейтинги поставщиков, региональная статистика и прогнозные модели', 'uz' => "Davlat xaridlari bozori haqida ma'lumotlar bilan interaktiv platforma: narx dinamikasi, yetkazib beruvchilar reytingi, mintaqaviy statistika va prognoz modellari", 'en' => 'Interactive platform with public procurement market data: price dynamics, supplier rankings, regional statistics and forecasting models'], 'features' => ['Интерактивные дашборды', 'Экспорт данных в Excel/PDF', 'API для интеграций', 'Прогнозная аналитика'], 'status' => 'В РАЗРАБОТКЕ · BETA Q3 2026', 'status_color' => '#3B82F6', 'link' => '#contacts', 'link_label' => ['ru' => 'Получить доступ', 'uz' => 'Kirish olish', 'en' => 'Get access']],
                        ['icon' => 'heroicons:shield-check',  'accent' => '#10B981', 'name' => ['ru' => 'Compliance Check', 'uz' => 'Compliance Check', 'en' => 'Compliance Check'], 'tagline' => ['ru' => 'Проверка рисков',        'uz' => 'Xatarlarni tekshirish',   'en' => 'Risk checker'],       'desc' => ['ru' => 'Автоматическая проверка тендерной документации заказчика на соответствие законодательству. Выявление дискриминационных требований и коррупционных рисков', 'uz' => "Buyurtmachining tender hujjatlarini qonunchilikka muvofiqligini avtomatik tekshirish. Kamsituvchi talablar va korrupsion xatarlarni aniqlash", 'en' => 'Automatic compliance check of tender documentation against legislation. Detection of discriminatory requirements and corruption risks'], 'features' => ['Проверка ТЗ за 5 минут', 'База нарушений АУГЗ', 'Генерация жалобы автоматически', 'Юридическая экспертиза'], 'status' => 'PILOT · ДЛЯ ЧЛЕНОВ АУГЗ', 'status_color' => '#10B981', 'link' => '#contacts', 'link_label' => ['ru' => "Список ожидания", 'uz' => "Kutish ro'yxati", 'en' => 'Waitlist']],
                        ['icon' => 'heroicons:sparkles',      'accent' => '#8B5CF6', 'name' => ['ru' => 'AI TenderDoc',     'uz' => 'AI TenderDoc',     'en' => 'AI TenderDoc'],     'tagline' => ['ru' => 'Автозаполнение заявок',  'uz' => "Arizalarni avtoto'ldirish", 'en' => 'Auto-fill applications'], 'desc' => ['ru' => 'Искусственный интеллект анализирует техническое задание и автоматически генерирует конкурентоспособную заявку на участие в тендере за считанные минуты', 'uz' => "Sun'iy intellekt texnik topshiriqni tahlil qiladi va bir necha daqiqada tenderda ishtirok etish uchun raqobatbardosh ariza avtomatik yaratadi", 'en' => 'AI analyses the technical specification and automatically generates a competitive tender application in minutes'], 'features' => ['Анализ ТЗ за 2 минуты', 'Генерация заявки по шаблону', 'На узбекском и русском', 'Интеграция с TenderZone'], 'status' => 'ЗАПУСК СЕНТЯБРЬ 2026', 'status_color' => '#8B5CF6', 'link' => '#contacts', 'link_label' => ['ru' => "Список ожидания", 'uz' => "Kutish ro'yxati", 'en' => 'Waitlist']],
                    ],
                ],
                [
                    'id'   => 'flagship',
                ...
                [
                    ...
                    'directions' => [
                        ['icon' => 'heroicons:chart-bar',           'title' => ['ru' => 'Мониторинг рынка закупок',      'uz' => 'Xaridlar bozorini monitoring',         'en' => 'Procurement market monitoring'],     'desc' => ['ru' => 'Ежеквартальные отчёты об объёмах, структуре и динамике рынка государственных закупок по секторам, регионам и типам процедур', 'uz' => "Davlat xaridlari bozorining hajmi, tuzilishi va dinamikasi bo'yicha choraklik hisobotlar", 'en' => 'Quarterly reports on volumes, structure and dynamics of the public procurement market by sectors, regions and procedure types'], 'tags' => ['ОБНОВЛЯЕТСЯ']],
                        ['icon' => 'heroicons:magnifying-glass',    'title' => ['ru' => 'Индекс прозрачности закупок',   'uz' => 'Xaridlar shaffoflik indeksi',          'en' => 'Procurement transparency index'],    'desc' => ['ru' => 'Рейтинг 14 регионов и крупнейших заказчиков по уровню прозрачности, конкурентности и цифровизации закупочных процедур', 'uz' => "14 mintaqa va eng yirik buyurtmachilarning shaffoflik, raqobatbardoshlik va raqamlashtirish darajasi bo'yicha reytingi", 'en' => 'Ranking of 14 regions and major customers by transparency, competitiveness and digitalization of procurement procedures'], 'tags' => ['ОБНОВЛЯЕТСЯ']],
                        ['icon' => 'heroicons:exclamation-triangle', 'title' => ['ru' => 'Реестр нарушений и рисков',    'uz' => 'Buzilishlar va xatarlar reestri',       'en' => 'Violations and risks register'],     'desc' => ['ru' => 'База данных выявленных нарушений в тендерных процедурах — дискриминационные требования, аффилированные победители, манипуляции с ценами', 'uz' => "Tender tartib-qoidalarida aniqlangan buzilishlar ma'lumotlar bazasi", 'en' => 'Database of identified violations in tender procedures — discriminatory requirements, affiliated winners, price manipulation'], 'tags' => ['ОБНОВЛЯЕТСЯ', 'ЗАКРЫТАЯ БД', 'ЧЛЕНЫ АУГЗ']],
                        ['icon' => 'heroicons:globe-alt',            'title' => ['ru' => 'Международные сравнения',      'uz' => 'Xalqaro taqqoslashlar',                'en' => 'International comparisons'],         'desc' => ['ru' => "Сравнительный анализ систем госзакупок Узбекистана, Казахстана, России, ОАЭ и других стран — лучшие практики и рекомендации для реформ", 'uz' => "O'zbekiston, Qozog'iston, Rossiya, BAA va boshqa mamlakatlar davlat xaridlari tizimlarining qiyosiy tahlili", 'en' => 'Comparative analysis of procurement systems in Uzbekistan, Kazakhstan, Russia, UAE and other countries — best practices and reform recommendations'], 'tags' => ['ОБНОВЛЯЕТСЯ', 'НА ЗАКАЗ']],
                    ],
                    'reports' => [
                        ['title' => ['ru' => 'Рынок госзакупок 2025: годовой отчёт',          'uz' => 'Davlat xaridlari bozori 2025: yillik hisobot',                            'en' => 'Public procurement market 2025: annual report'],    'meta' => 'PDF · 48 СТР.', 'desc' => ['ru' => 'Полный анализ за 2025 год: 42 трлн сум контрактов, региональная разбивка, топ-100 заказчиков и поставщиков, выявленные нарушения', 'uz' => "2025 yil uchun to'liq tahlil: 42 trillion so'm shartnomalar, mintaqaviy bo'linma, top-100 buyurtmachilar va yetkazib beruvchilar", 'en' => 'Full 2025 analysis: 42 trillion sum in contracts, regional breakdown, top-100 customers and suppliers, identified violations'], 'date' => 'Март 2026',  'downloads' => '5 440 скачиваний', 'btn' => ['ru' => 'Скачать PDF', 'uz' => 'PDF yuklab olish', 'en' => 'Download PDF'], 'href' => '#'],
                        ['title' => ['ru' => 'Индекс прозрачности регионов — 2026',           'uz' => 'Mintaqalar shaffoflik indeksi — 2026',                                    'en' => 'Regional transparency index — 2026'],               'meta' => 'PDF · 32 СТР.', 'desc' => ['ru' => 'Рейтинг всех 14 регионов по 5 метрикам: цифровизация, конкурентность, доля МСБ, сроки, обжалования', 'uz' => "Barcha 14 mintaqaning 5 ko'rsatkich bo'yicha reytingi: raqamlashtirish, raqobatbardoshlik, KO'B ulushi, muddatlar, shikoyatlar", 'en' => 'Ranking of all 14 regions across 5 metrics: digitalization, competitiveness, SMB share, deadlines, appeals'], 'date' => 'Апрель 2026', 'downloads' => '3 120 скачиваний', 'btn' => ['ru' => 'Скачать PDF', 'uz' => 'PDF yuklab olish', 'en' => 'Download PDF'], 'href' => '#'],
                        ['title' => ['ru' => 'Цифровизация закупок в СНГ: сравнение',          'uz' => 'MDH davlatlarida xaridlarni raqamlashtirish: taqqoslash',                  'en' => 'CIS procurement digitalization: comparison'],       'meta' => 'PDF · 28 СТР.', 'desc' => ['ru' => 'Узбекистан, Казахстан, Кыргызстан — 5 метрик эффективности электронных закупочных систем и рекомендации', 'uz' => "O'zbekiston, Qozog'iston, Qirg'iziston — elektron xarid tizimlarining 5 samaradorlik ko'rsatkichi va tavsiyalar", 'en' => 'Uzbekistan, Kazakhstan, Kyrgyzstan — 5 efficiency metrics for electronic procurement systems and recommendations'], 'date' => 'Март 2026',  'downloads' => '2 270 скачиваний', 'btn' => ['ru' => 'Скачать PDF', 'uz' => 'PDF yuklab olish', 'en' => 'Download PDF'], 'href' => '#'],
                    ],
                ],
                [
                    'id'   => 'support',
                    ...
                    'plans' => [
                        ['icon' => 'heroicons:document-text', 'accent' => '#D1832C', 'name' => ['ru' => 'Базовое сопровождение',        'uz' => 'Asosiy hamrohlik',          'en' => 'Basic support'],          'desc' => ['ru' => 'Поддержка на этапе подготовки и подачи заявки. Проверка документов, консультации по требованиям ТЗ и ценовой стратегии', 'uz' => "Ariza tayyorlash va topshirish bosqichida yordam. Hujjatlarni tekshirish, texnik shartlar va narx strategiyasi bo'yicha maslahatlar", 'en' => 'Support at the application preparation and submission stage. Document review, technical specification and pricing strategy consultations'], 'features' => ['Проверка заявки', 'Анализ ТЗ и требований', 'Ценовые рекомендации', 'Консультация до 3 часов'], 'price' => ['ru' => 'от 500 000 сум / тендер', 'uz' => "tender uchun 500 000 so'mdan", 'en' => 'from 500,000 UZS / tender']],
                        ['icon' => 'heroicons:scale',          'accent' => '#8B5CF6', 'name' => ['ru' => 'Правовая защита',              'uz' => 'Huquqiy himoya',            'en' => 'Legal protection'],       'desc' => ['ru' => 'Полное юридическое сопровождение: обжалование дискриминационных условий, защита при отклонении заявки, представительство в ГЗКУ и Антимонопольном комитете', 'uz' => "To'liq yuridik hamrohlik: kamsituvchi shartlarga shikoyat, ariza rad etilganda himoya, DXKU va Monopoliyaga qarshi qo'mitada vakillik", 'en' => 'Full legal support: appealing discriminatory conditions, protection against application rejection, representation before GPPA and Antimonopoly Committee'], 'features' => ['Анализ оснований для жалобы', 'Подготовка жалобы', 'Представительство в органах', '98% успешных обжалований'], 'price' => ['ru' => 'от 1 500 000 сум / дело', 'uz' => "ish uchun 1 500 000 so'mdan", 'en' => 'from 1,500,000 UZS / case']],
                        ['icon' => 'heroicons:trophy',         'accent' => '#3B82F6', 'name' => ['ru' => 'Комплексное VIP-сопровождение', 'uz' => 'Kompleks VIP-hamrohlik',    'en' => 'Comprehensive VIP support'], 'desc' => ['ru' => 'Полный цикл от поиска тендера до исполнения контракта. Персональный менеджер, приоритетная поддержка 24/7 и гарантия качества результата', 'uz' => "Tenderni topishdan shartnomani bajarishgacha to'liq tsikl. Shaxsiy menejer, 24/7 ustuvor qo'llab-quvvatlash va natija sifati kafolati", 'en' => 'Full cycle from tender search to contract execution. Personal manager, priority 24/7 support and quality result guarantee'], 'features' => ['Поиск и отбор тендеров', 'Полный пакет документов', 'Правовая защита включена', 'Персональный менеджер'], 'price' => ['ru' => 'По договору · индивидуально', 'uz' => "Shartnoma bo'yicha · individual", 'en' => 'By agreement · individual']],
                    ],
                ],
                [
                    'id'   => 'extra-services',
                    ...
                    'services' => [
                        ['emoji' => '📄', 'name' => ['ru' => 'Шаблоны документов',   'uz' => 'Hujjat shablonlari',             'en' => 'Document templates'],   'desc' => ['ru' => 'Библиотека из 50+ готовых шаблонов тендерных заявок, гарантийных писем, договоров и актов для Узбекистана', 'uz' => "O'zbekiston uchun 50+ tayyor tender arizalari, kafolat xatlari, shartnomalar va dalolatnomalar kutubxonasi", 'en' => 'Library of 50+ ready-made templates for tender applications, guarantee letters, contracts and acts for Uzbekistan'], 'link_label' => ['ru' => 'Скачать',           'uz' => 'Yuklab olish',       'en' => 'Download'], 'href' => '#'],
                        ['emoji' => '🔔', 'name' => ['ru' => 'Telegram-мониторинг',  'uz' => 'Telegram-monitoring',            'en' => 'Telegram monitoring'],  'desc' => ['ru' => 'Персонализированный бот для мгновенных уведомлений о новых тендерах по вашим параметрам — до 50 уведомлений в день', 'uz' => "Parametrlaringiz bo'yicha yangi tenderlar haqida tezkor bildirishnomalar uchun shaxsiylashtirilgan bot — kuniga 50 tagacha bildirishnoma", 'en' => 'Personalised bot for instant notifications about new tenders by your parameters — up to 50 notifications per day'], 'link_label' => ['ru' => 'Подключить',        'uz' => "Ulash",              'en' => 'Connect'],  'href' => '#'],
                        ['emoji' => '🏛', 'name' => ['ru' => 'Аккредитация',         'uz' => 'Akkreditatsiya',                 'en' => 'Accreditation'],        'desc' => ['ru' => 'Помощь в регистрации и аккредитации на e-xarid.uz, TenderZone, cooperation.uz и других закупочных платформах', 'uz' => "e-xarid.uz, TenderZone, cooperation.uz va boshqa xarid platformalarida ro'yxatdan o'tish va akkreditatsiyada yordam", 'en' => 'Assistance with registration and accreditation on e-xarid.uz, TenderZone, cooperation.uz and other procurement platforms'], 'link_label' => ['ru' => 'Заказать',          'uz' => 'Buyurtma berish',    'en' => 'Order'],    'href' => '#'],
                        ['emoji' => '📰', 'name' => ['ru' => 'PR и репутация',        'uz' => "PR va obro'",                   'en' => 'PR & reputation'],      'desc' => ['ru' => 'Размещение материалов о компании на площадках АУГЗ, участие в форумах как спикер, повышение узнаваемости на закупочном рынке', 'uz' => 'AUGZ platformalarida kompaniya haqida materiallarni joylashtirish, forumlarda spiker sifatida ishtirok etish, xaridlar bozorida tanilishni oshirish', 'en' => 'Placement of company materials on AUGZ platforms, participation in forums as a speaker, increasing brand recognition in the procurement market'], 'link_label' => ['ru' => 'Обсудить',          'uz' => 'Muhokama qilish',    'en' => 'Discuss'],  'href' => '#'],
                        ['emoji' => '🎓', 'name' => ['ru' => 'Корпоративное обучение', 'uz' => "Korporativ ta'lim",             'en' => 'Corporate training'],   'desc' => ['ru' => 'Индивидуальные тренинги и воркшопы по госзакупкам для команды компании — офлайн в Ташкенте или онлайн', 'uz' => "Kompaniya jamoasi uchun individual treninglar va master-klasslar — Toshkentda oflayn yoki onlayn", 'en' => 'Individual training and workshops on public procurement for your company team — offline in Tashkent or online'], 'link_label' => ['ru' => 'Заказать тренинг',  'uz' => 'Trening buyurtma berish', 'en' => 'Order training'], 'href' => '#'],
                    ],
                ],
                [
                    'id'   => 'cta',
        ...
        return [
            ...
            'benefits' => [
                ...
                'items'   => [
                    ...
                    ['icon' => 'heroicons:academic-cap',   'icon_bg' => 'bg-green-900/60',  'title' => ['ru' => 'Обучение и курсы',      'uz' => "Ta'lim va kurslar",            'en' => 'Training & courses'],      'description' => ['ru' => '5 учебных программ со скидкой до 50% для членов АУГЗ. Дистанционно и очно',                    'uz' => "AUGZ a'zolari uchun 50% gacha chegirma bilan 5 ta o'quv dasturi. Masofaviy va bevosita",               'en' => '5 training programs with up to 50% discount for AUGZ members. Remote and in-person']],
    ...
    private function reportContent(): array
    {
        return [
            ...
            'sidebar' => [
                ...
                'stats' => [
                    ['icon' => 'ph:files',        'value' => '1 240+', 'label' => ['ru' => 'Обращений рассмотрено',    'uz' => 'Murojaatlar ko\'rib chiqildi', 'en' => 'Complaints reviewed']],
                    ['icon' => 'ph:check-circle', 'value' => '87%',    'label' => ['ru' => 'Успешно урегулировано',    'uz' => 'Muvaffaqiyatli hal qilindi',  'en' => 'Successfully resolved']],
                    ['icon' => 'ph:clock',        'value' => '7',      'label' => ['ru' => 'Среднее время ответа (дней)', 'uz' => "O'rtacha javob vaqti (kun)", 'en' => 'Average response time (days)']],
                ],
            ],
            'form' => [
                'tabs' => [
            ...
            'success_modal' => [
                ...
                'meta_category' => ['ru' => 'Категория',     'uz' => 'Kategoriya',          'en' => 'Category'],
                ...
                'category_name' => ['ru' => 'Нарушение контракта', 'uz' => 'Shartnoma buzilishi',   'en' => 'Contract violation'],
                'progress_steps' => [
